...
clear;clear;clear
  ...
  # // Banner
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo -e "  Welcome To sabdestore Script Installer ${YELLOW}(${NC}${green} Stable Edition ${NC}${YELLOW})${NC}"
echo -e "     This Will Quick Setup VPN Server On Your Server"
echo -e "         Auther : ${green}sabdestore ${NC}${YELLOW}(${NC} ${green}sabdestore ${NC}${YELLOW})${NC}"
echo -e "       © Recode By sabdestore ${YELLOW}(${NC} 2024 ${YELLOW})${NC}"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
sleep 5
###### IZIN SC 
...
data_ip="https://raw.githubusercontent.com/sabdestore/vvip/main/izin"
checking_sc() {
  ...
  if [[ $date_list < $useexp ]]; then
    ...
    echo -e "      \033[0;36mTelegram${NC} t.me/sabdestore"
    echo -e "      ${GREEN}WhatsApp${NC} wa.me/6285770346443"
    echo -e "\033[1;93m────────────────────────────────────────────\033[0m"
    echo -e ""
...
# USERNAME
rm -f /usr/bin/user
username=$(curl https://raw.githubusercontent.com/sabdestore/vvip/main/izin | grep $MYIP | awk '{print $2}')
echo "$username" >/usr/bin/user
expx=$(curl https://raw.githubusercontent.com/sabdestore/vvip/main/izin | grep $MYIP | awk '{print $3}')
echo "$expx" >/usr/bin/e
# DETAIL ORDER
username=$(cat /usr/b																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																in/user)
oid=$(cat /usr/bin/ver)
exp=$(cat /usr/bin/e)
clear
# CERTIFICATE STATUS
...
Exp1=$(curl https://raw.githubusercontent.com/sabdestore/vvip/main/izin | grep $MYIP | awk '{print $4}')
if [[ $today < $Exp1 ]]; then
sts="${Info}"
else
sts="${Error}"
...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/sabdestore/vvip/main/"
...
function password_default() {
	...
	today=`date -d "0 days" +"%Y-%m-%d"`
	valid=$(curl https://raw.githubusercontent.com/sabdestore/vvip/main/izin | grep $MYIP | awk '{print $3}')
	d1=$(date -d "$valid" +%s)
	d2=$(date -d "$today" +%s)
	certifacate=$(((d1 - d2) / 86400))
    ...
    CHATID="5340548062"
    KEY="7114283702:AAF8-cbUFdDMB7KmeC-UVR5ocPAEhb1hn1M"
    TIME="10"
...
print_success "UDP-CUSTOM BY sabdestore"
}
